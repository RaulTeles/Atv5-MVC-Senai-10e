...
using LHPet10e.Models;

namespace LHPet10e.Controllers;
...
public class HomeController : Controller
{
    ...
    public IActionResult Index()
    {
        ...
        Cliente cliente1 = new Cliente(01, "Raul Teles","123.456.789-00","telesraul@gmail.com","Snoopy");
        ...
        // Mandando a lista de clientes para a View
        ...
        // Criando lista de Fornecedoeres
        List<Fornecedor> listaFornecedores = new List<Fornecedor>();

        // Adicionando Fornecedores Criados
        ...
        // Mandando a lista de Fornecedores para a View
